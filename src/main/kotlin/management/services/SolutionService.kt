...
//        partnerService.exportDefault()
        ...
        return solutionRepository.saveAll(
            listOf(
                ...
                Solution(
                    alias = "smart_and_card_docless",
                    name = "iKassa Smart&Card PAX A930",
                    legalName = "iKassa Smart&Card",
                    contents = defaultProducts
                ),
                Solution(
                    alias = "smart_and_card_generic_docless",
                    name = "iKassa Smart&Card",
                    legalName = "iKassa Smart&Card",
                    contents = defaultProducts
                ),
                Solution(
                    alias = "smart_and_card_azur_docless",
                    name = "iKassa Smart&Card Azur",
                    legalName = "iKassa Smart&Card",
                    contents = defaultProducts
                ),
                Solution(
                    alias = "smart_and_card_nexgo_docless",
                    name = "iKassa Smart&Card NexGo",
                    legalName = "iKassa Smart&Card",
                    contents = defaultProducts
                ),
                Solution(
                    alias = "smart_and_card_a910_docless",
                ...
                Solution(
                    alias = "smart_and_card_belgazprom",
                ...
                Solution(
                    alias = "smart_and_card_belarusbank",
                ...
                Solution(
                    alias = "smart_and_card_paritetbank",
                    name = "iKassa Smart&Card ОАО «Паритетбанк»",
                    legalName = "iKassa Smart&Card",
                    contents = defaultProducts,
                    equipment = listOf(productService.getProductByAlias(alias = "pax930_lancard")!!),
                    extraVars = mapOf("PROCESSINGPROVIDER" to "ОАО «Паритетбанк»"),
                    forcedInstructionPdf = AccompanyingDoc(
                        path = "static/forced_paritet.pdf",
                        name = "00-Инструкция.pdf",
                        raw = true
                    )
                ),
                Solution(
                ...
                Solution(
                    alias = "smart_and_card_azur_belweb",
                ...
                Solution(
                    alias = "smart_and_card_azur_prior",
                ...
                Solution(
                    ...
                    forcedInstructionPdf = AccompanyingDoc(
                        path = "static/forced_a1_smart.pdf",
                        name = "00-Инструкция.pdf",
                        raw = true
                    ),
                    version = "2.5.0"
                ...
                Solution(
                    alias = "smart_and_card_docless_a1",
                    name = "iKassa Smart&Card PAX A930",
                    legalName = "iKassa Smart&Card",
                    contents = defaultProducts,
                    forcedInstructionPdf = AccompanyingDoc(
                        path = "static/forced_a1_pax.pdf",
                        name = "00-Инструкция.pdf",
                        raw = true
                    )
                ),
                Solution(
                    alias = "smart_and_card_a910",
                    name = "iKassa Smart&Card PAX A910",
                    legalName = "iKassa Smart&Card",
                    contents = defaultProducts,
                ...
                Solution(
                    alias = "smart_and_card_tehnobank",
                    name = "iKassa Smart&Card PAX A930",
                    legalName = "iKassa Smart&Card",
                    contents = defaultProducts,
                    related = listOf(productService.getProductByAlias(alias = "adapter_typec")!!),
